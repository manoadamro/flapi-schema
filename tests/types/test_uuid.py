...
class UuidTest(unittest.TestCase):
    ...
    def test_strip_hyphens(self):
        prop = flapi_schema.types.Uuid(strip_hyphens=True)
        self.assertEqual(
    ...
    def test_nullable_allows_null(self):
        prop = flapi_schema.types.Uuid(nullable=True)
        self.assertIsNone(prop(None))

    def test_nullable_raises_error(self):
        prop = flapi_schema.types.Uuid(nullable=False)
        self.assertRaises(flapi_schema.errors.SchemaValidationError, prop, None)

    def test_default_is_none(self):
        prop = flapi_schema.types.Uuid(default=None)
        self.assertIsNone(prop(None))

    def test_default_value(self):
        prop = flapi_schema.types.Uuid(default="9689c6bd-8cfa-4888-a92c-7d23599b94aa")
        self.assertEqual(prop(None), "9689c6bd-8cfa-4888-a92c-7d23599b94aa")

    def test_default_passive_when_value_not_none(self):
        prop = flapi_schema.types.Uuid(default="9689c6bd-8cfa-4888-a92c-7d23599b94ab")
        self.assertEqual(
            prop("9689c6bd-8cfa-4888-a92c-7d23599b94aa"),
    ...
    def test_wrong_type(self):
        prop = flapi_schema.types.Uuid(callback=None)
